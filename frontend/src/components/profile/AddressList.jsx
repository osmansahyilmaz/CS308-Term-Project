...
const AddressList = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            if (editingAddressId) {
                await axios.put(`http://localhost:5000/api/addresses/${editingAddressId}`, formData, {
                    withCredentials: true
                });
            ...
            setError(error.response?.data?.error || 'An error occurred while saving the address.');
        }
    };
    ...
    const handleDelete = async (addressId) => {
        ...
        try {
            ...
            setError(error.response?.data?.error || 'An error occurred while deleting the address.');
        }
    };
